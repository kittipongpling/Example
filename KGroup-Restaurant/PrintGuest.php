...
@page 
    ...
    body 
    {
        margin: 10px;  /* เป็นการกำหนดขอบกระดาษของเนื้อหาที่จะพิมพ์ก่อนที่จะส่งไปให้เครื่องพิมพ์ครับ */
      ...
      <body style="font-family: 'Kanit', sans-serif;">  
          ...
          <div id="divprint"> 
           <div class="container" style="width:700px; vertical-align: bottom;">  
               ...
               <img src="images/icons/KeereeMantra.png" width="40%">
               ...
               <hr style="margin-top: 5px; border-top: 2px solid #969595;">
               <?php }?>
               ...
               <?php }?>
                ...
                <h4 align="center" style="margin-top: 30px; margin-bottom: 0px;">ใบยืนยันการจองรายการอาหาร</h4><br />  
                <div class="table-responsive">  
                    <table class="table table-bordered" >  
                        <tr>
                            ...
                            โต๊ะที่ : <?php if ($result2["ResName"]=='Loft'){
                          ...
                          <tr>
                            ...
                            <td>เบอร์โทรติดต่อ : <?php echo $result["GuestTel"]; ?> ( <?php echo $result["GuestTelBackup"]; ?> )</td>
                          </tr>
                          <tr>
                            <td>Line ID : <?php echo $result["GuestLine"]; ?></td>
                            <td>วันที่เข้าร้าน : <?php echo DateThai($result["DataIn"]); ?>  เวลา : <?php echo $result["TimeIn"]; ?> น.</td>
                          </tr>
                         <tr>
                    ...
                    <h4 align="left" style="margin-top: 30px; margin-bottom: -10px;">รายการอาหาร</h4><br />  
                        ...
                        <tr>
                            <td width="50%">
                                <table class="table table-bordered" width="50%">  
                                  <tr>
                                    <td width="40%" colspan="2">รายการอาหารที่ 1 : <?php echo $result["MenuName1"]; ?></td>
                                  </tr>
                                  <tr>
                                    <td colspan="2">รายการอาหารที่ 2 : <?php echo $result["MenuName2"]; ?></td>
                                  </tr>
                                  <tr>
                                    <td colspan="2">รายการอาหารที่ 3 : <?php echo $result["MenuName3"]; ?></td>
                                  </tr>
                                  <tr>
                                    <td colspan="2">รายการอาหารที่ 4 : <?php echo $result["MenuName4"]; ?></td>
                                  </tr>
                                  <tr>
                                    <td colspan="2">รายการอาหารที่ 5 : <?php echo $result["MenuName5"]; ?></td>
                                  </tr>
                                </table>
                              </td>
                            <td width="50%">
                                <table class="table table-bordered" width="50%">  
                                  <tr>
                                    <td width="40%" colspan="2">รายการอาหารที่ 6 : <?php echo $result["MenuName6"]; ?></td>
                                  </tr>
                                  <tr>
                                    <td colspan="2">รายการอาหารที่ 7 : <?php echo $result["MenuName7"]; ?></td>
                                  </tr>
                                  <tr>
                                    <td colspan="2">รายการอาหารที่ 8 : <?php echo $result["MenuName8"]; ?></td>
                                  </tr>
                                  <tr>
                                    <td colspan="2">รายการอาหารที่ 9 : <?php echo $result["MenuName9"]; ?></td>
                                  </tr>
                                  <tr>
                                    <td colspan="2">เพิ่มเติม : <?php echo $result["MenuName10"]; ?></td>
                                  </tr>
                                </table>
                              </td>
                          </tr>
                          ...
                          <tr>
                            <td colspan="2">
                              <table class="table table-bordered" width="10%">  
                                  ...
                                  <tr>
                                    <td width="13%" colspan="2">รายการอาหาตามสั่ง : <?php echo $result["MenuOther"]; ?></td>
                                  </tr>
                                  <?php } ?>
                              </table>
                              </td>
                ...
                <ul style="font-size: 18px; line-height: 15px; margin-left: -30px;">
                <p>กรุณามัดจำการจองรายการอาหารล่วงหน้าก่อนเข้ารับบริการ </p>
                <p style="display: inline-block;"> เป็นจำนวนเงิน 
                <p  style="display: inline-block; font-size: 22px;">
                &nbsp; <?php echo number_format($result["Pledge"]); ?> &nbsp;</p>บาท 
                จากจำนวนเต็ม<p style="display: inline-block; font-size: 22px;">
                &nbsp; <?php echo number_format($result["TotalPrice"]); ?> &nbsp;</p>บาท </p>
                    
                <p style="margin-top: -7px;">มาที่ : ชื่อบัญชี นายสาโรจน์ กมลพันทิพย์ ธนาคารกรุงเทพ สาขา โรบินสัน กาญจนบุรี </br>
                <p style="display: inline-block;">บัญชีเงินฝากสะสมทรัพย์ เลขที่บัญชี &nbsp;
                <p style="display: inline-block; font-size: 22px;">632-7-03208-9</p> </p>
                <p style="margin-top: -7px;">กรุณาแฟกซ์หลักฐานการโอนมาที่เบอร์ 034-513000</p>
                    
               <ul style="font-size: 14px; line-height: 12px; margin-left: -40px;">
               <p style="font-weight: 600; text-decoration: underline; margin-top: 20px;">
               <br>หมายเหตุ</p>
               ...
               <br><br><p style="font-weight: 600; font-size: 16px; text-decoration: underline; line-height: 25px;">
