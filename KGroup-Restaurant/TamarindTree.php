                        ...
                        <div class="col-lg-8 col-md-7">
                            ...
                            <div class="header">
                              <h4 class="title" style="font-family: 'Trirong', serif;">แผนผังร้าน คีรีธารา</h4>
                                ...
                                <br><p id="rcorners2">โซนต้นมะขาม </p>
                                ...
                                <div class="canvas">
                                    ...
                                    <table style="width:100%">
                                        ...
                                        <table width="100%" border="0" >
                                          <tr>
                                            <td>
                                              <table width="90%" border="0" class="TamarindTree">
                                                <tr>
                                                <?php 
                                                require_once("connection.php");
                                                $rn = 0;
                                                $PathIcon = "images/MantraPlan/TableIcon/";
                                                $sql = "SELECT * FROM (SELECT tablemantraplan.*,bookingres.BKStatus FROM tablemantraplan LEFT JOIN bookingres ON tablemantraplan.TableID = bookingres.TableID WHERE bookingres.DataIn = '$_SESSION[SelectDate]' AND bookingres.TimeRange = '$_SESSION[SelectTime]' AND tablemantraplan.TableZone ='2' AND tablemantraplan.TableGroup ='B' AND tablemantraplan.ResName ='KeereeTara' UNION All SELECT tablemantraplan.*,tablemantraplan.TableStatus FROM tablemantraplan LEFT JOIN bookingres ON tablemantraplan.TableID = bookingres.TableID WHERE TableZone ='2' AND TableGroup ='B' AND tablemantraplan.ResName ='KeereeTara') As TBid GROUP BY TBid.TableID ORDER BY TBid.Orders ASC";
                                          ...
                                          <tr>
                                            <td>
                                              <table width="90%" border="0" class="TamarindTree2">
                                                <tr>
                                                <?php 
                                                require_once("connection.php");
                                                $rn = 0;
                                                $PathIcon = "images/MantraPlan/TableIcon/";
                                                $sql = "SELECT * FROM (SELECT tablemantraplan.*,bookingres.BKStatus FROM tablemantraplan LEFT JOIN bookingres ON tablemantraplan.TableID = bookingres.TableID WHERE bookingres.DataIn = '$_SESSION[SelectDate]' AND tablemantraplan.TableZone ='2' AND tablemantraplan.TableGroup ='A' AND tablemantraplan.ResName ='KeereeTara' UNION All SELECT tablemantraplan.*,tablemantraplan.TableStatus FROM tablemantraplan LEFT JOIN bookingres ON tablemantraplan.TableID = bookingres.TableID WHERE TableZone ='2' AND TableGroup ='A' AND tablemantraplan.ResName ='KeereeTara') As TBid GROUP BY TBid.TableID ORDER BY TBid.Orders ASC";
                                                $query = mysqli_query($conn,$sql);
                                                while($result=mysqli_fetch_array($query,MYSQLI_ASSOC))
	                                               {
                                                    $NewVar = $result["TableNumber"];
