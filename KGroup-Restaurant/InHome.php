                        ...
                        <div class="col-lg-8 col-md-7">
                            ...
                            <div class="header">
                              <h4 class="title" style="font-family: 'Trirong', serif;">แผนผังร้าน คีรีธารา</h4>
                                ...
                                <br><p id="rcorners2">โซนห้องแอร์ </p>
                            <div class="content table-responsive table-full-width">
                                <div class="canvas">
                                    ...
                                    <table style="width:100%">
                                        ...
                                        <table width="90%" border="0" class="InHome">
                                            <tr>
                                                ...
                                                $sql = "SELECT * FROM (SELECT tablemantraplan.*,bookingres.BKStatus FROM tablemantraplan LEFT JOIN bookingres ON tablemantraplan.TableID = bookingres.TableID WHERE bookingres.DataIn = '$_SESSION[SelectDate]' AND bookingres.TimeRange = '$_SESSION[SelectTime]' AND tablemantraplan.TableZone ='1' AND tablemantraplan.TableGroup ='A' AND tablemantraplan.ResName ='KeereeTara' UNION All SELECT tablemantraplan.*,tablemantraplan.TableStatus FROM tablemantraplan LEFT JOIN bookingres ON tablemantraplan.TableID = bookingres.TableID WHERE TableZone ='1' AND TableGroup ='A' AND tablemantraplan.ResName ='KeereeTara') As TBid GROUP BY TBid.TableID ORDER BY TBid.TableID DESC";
