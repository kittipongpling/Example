                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="content" style="margin-left: 15px;">
                                ...
                                <p><a href="TaraPlan.php?ResName=KeereeTara<?php unset($_SESSION['SelectDate']); unset($_SESSION['SelectTime']);?>">
                                    <img src="assets/img/logo/Keereetara.png" style='height: 90%; width: 90%; object-fit: contain'></p></a>
                                <p><a href="LoftPlan.php?ResName=Loft<?php unset($_SESSION['SelectDate']); unset($_SESSION['SelectTime']);?>">
