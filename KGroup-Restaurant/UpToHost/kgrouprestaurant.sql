...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 06, 2018 at 10:28 AM
...
(445, 'RabbitTie', '$2y$04$oVkUo/XlxIJH6MO3Bi6xa.rlnyzVXVkkdWfzM1WCU43W58BmDuKtW', 'samsorn', 'innak', '0980635827', 'Admin'),
(501, 'Tester', '$2y$10$YXrcbYYntg78ZcjCY9cu7eEWHKvPOg78BSv9ESNN1cmoAndFvprzO', 'Tester', 'Tester', '00000000', 'Editor');
...
--
ALTER TABLE `guest`
  MODIFY `GuestID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `user`
  MODIFY `ID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=509;
COMMIT;
